...
extension BitriseSwaggerAPI.Organizations {
    ...
    */
    public enum OrgList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = OrganizationListRespModel

            /** OK */
            case status200(OrganizationListRespModel)
            ...
            public var success: OrganizationListRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<OrganizationListRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(OrganizationListRespModel.self, from: data))
