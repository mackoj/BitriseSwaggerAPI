    ...
    */
    public enum AvatarCandidateList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = FindAvatarCandidateResponse

            /** OK */
            case status200(FindAvatarCandidateResponse)
            ...
            public var success: FindAvatarCandidateResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<FindAvatarCandidateResponse, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(FindAvatarCandidateResponse.self, from: data))
