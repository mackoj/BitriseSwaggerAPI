...
extension BitriseSwaggerAPI.BuildCertificate {
    ...
    */
    public enum BuildCertificateList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BuildCertificateListResponseModel

            /** OK */
            case status200(BuildCertificateListResponseModel)
            ...
            public var success: BuildCertificateListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BuildCertificateListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BuildCertificateListResponseModel.self, from: data))
