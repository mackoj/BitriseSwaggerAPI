    ...
    */
    public enum AppWebhookCreate {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = WebhookRespModel

            /** OK */
            case status200(WebhookRespModel)
            ...
            public var success: WebhookRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<WebhookRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(WebhookRespModel.self, from: data))
