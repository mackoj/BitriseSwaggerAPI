    ...
    */
    public enum BuildShow {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BuildShowResponseModel

            /** OK */
            case status200(BuildShowResponseModel)
            ...
            public var success: BuildShowResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BuildShowResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BuildShowResponseModel.self, from: data))
