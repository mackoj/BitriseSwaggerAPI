    ...
    */
    public enum BuildWorkflowList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BuildWorkflowListResponseModel

            /** OK */
            case status200(BuildWorkflowListResponseModel)
            ...
            public var success: BuildWorkflowListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BuildWorkflowListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BuildWorkflowListResponseModel.self, from: data))
