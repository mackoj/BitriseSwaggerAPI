    ...
    */
    public enum BuildTrigger {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: BuildTriggerParams

            public init(body: BuildTriggerParams, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(appSlug: String, body: BuildTriggerParams) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = BuildTriggerRespModel

            /** OK */
            case status200(BuildTriggerRespModel)
            ...
            public var success: BuildTriggerRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<BuildTriggerRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(BuildTriggerRespModel.self, from: data))
