    ...
    */
    public enum ArtifactList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ArtifactListResponseModel

            /** OK */
            case status200(ArtifactListResponseModel)
            ...
            public var success: ArtifactListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ArtifactListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ArtifactListResponseModel.self, from: data))
