...
extension BitriseSwaggerAPI.Activity {
    ...
    */
    public enum ActivityList {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = ActivityEventListResponseModel

            /** OK */
            case status200(ActivityEventListResponseModel)
            ...
            public var success: ActivityEventListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ActivityEventListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ActivityEventListResponseModel.self, from: data))
