...
extension BitriseSwaggerAPI.AppSetup {
    ...
    public enum AppConfigCreate {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: AppConfigRequestParam

            public init(body: AppConfigRequestParam, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(appSlug: String, body: AppConfigRequestParam) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppConfigRespModel

            /** OK */
            case status200(AppConfigRespModel)
            ...
            public var success: AppConfigRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppConfigRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppConfigRespModel.self, from: data))
