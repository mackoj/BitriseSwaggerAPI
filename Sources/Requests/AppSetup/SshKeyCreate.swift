    ...
    */
    public enum SshKeyCreate {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: SSHKeyUploadParams

            public init(body: SSHKeyUploadParams, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(appSlug: String, body: SSHKeyUploadParams) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = SSHKeyRespModel

            /** OK */
            case status200(SSHKeyRespModel)
            ...
            public var success: SSHKeyRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<SSHKeyRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(SSHKeyRespModel.self, from: data))
