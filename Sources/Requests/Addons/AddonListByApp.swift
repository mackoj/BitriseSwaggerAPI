...
extension BitriseSwaggerAPI.Addons {
    ...
    */
    public enum AddonListByApp {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppAddOnsListResponseModel

            /** OK */
            case status200(AppAddOnsListResponseModel)
            ...
            public var success: AppAddOnsListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppAddOnsListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppAddOnsListResponseModel.self, from: data))
