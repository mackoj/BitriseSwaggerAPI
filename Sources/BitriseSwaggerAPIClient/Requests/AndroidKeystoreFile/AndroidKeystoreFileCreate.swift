    ...
    */
    public enum AndroidKeystoreFileCreate {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: AndroidKeystoreFileUploadParams

            public init(body: AndroidKeystoreFileUploadParams, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(appSlug: String, body: AndroidKeystoreFileUploadParams) {
