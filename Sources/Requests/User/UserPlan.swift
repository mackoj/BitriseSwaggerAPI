    ...
    */
    public enum UserPlan {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = UserPlanRespModel

            /** OK */
            case status200(UserPlanRespModel)
            ...
            public var success: UserPlanRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<UserPlanRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(UserPlanRespModel.self, from: data))
