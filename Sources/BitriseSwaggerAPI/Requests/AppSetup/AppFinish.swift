    ...
    */
    public enum AppFinish {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public var body: AppFinishParams

            public init(body: AppFinishParams, options: Options, encoder: RequestEncoder? = nil) {
                self.body = body
            ...
            public convenience init(appSlug: String, body: AppFinishParams) {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = AppFinishRespModel

            /** OK */
            case status200(AppFinishRespModel)
            ...
            public var success: AppFinishRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<AppFinishRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(AppFinishRespModel.self, from: data))
